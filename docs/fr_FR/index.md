...
- Support de l'horoscopes occidental (12 signes) et chinois (12 signes)
...
6. Sauvegarder — les commandes correspondant aux différents thèmes seront automatiquement créés et les informations récupérées
...
Horoscope Chinois : Rat, Bœuf, Tigre, Lièvre, Dragon, Serpent, Cheval, Chèvre, Singe, Coq, Chien, Cochon
	* le site "mon-horoscope-du-jour.com" utilise "Lièvre" plutôt que "Lapin"
...
<p>**Utilisation :**</p>
	<p>Sur une commande de design :</p>
		<p>1. Ajouter la commande `Logo` de l'équipement HoroscopePlus sur un design</p>
	...
	<p>2. Dans la configuration de la commande > Affichage > Widget, sélectionner `Customtemp/HoroscopePlus_logo`</p>
	...
	<p>3. Le logo s'affiche et ouvre automatiquement le bon horoscope au clic</p>
	<p align="center"><img width="581" height="386" align=center alt="image" src="https://github.com/user-attachments/assets/23f65796-c989-4f7e-8add-c70a9e13e16a" /></p>

<p>Dans un virtuel :</p>
	<p>1. Créer un nouveau virtuel</p>
	<p>2. Importer les commandes `Logo` + `date` (optionnel) de chaque signe à visualiser</p>
	...
	<p>3. Dans la configuration de la commande `Logo`> Affichage > Widget, sélectionner `Customtemp/HoroscopePlus_logo`</p>
	...
	<p>4. Optionnel : Afficher le virtuel en mode "tableau </p>
