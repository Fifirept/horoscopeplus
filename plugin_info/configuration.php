    ...
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">
                ...
                <sup><i class="fas fa-question-circle" title="{{Expression cron définissant la fréquence de mise à jour de tous les horoscopes. Par défaut : tous les jours à minuit.}}"></i></sup>
            </label>
            <div class="col-sm-6">
                ...
                <span class="help-block">{{Laisser vide pour utiliser le cron quotidien par défaut (minuit). Exemple : "30 7 * * *" pour tous les jours à 7h30.}}</span>
            </div>
        </div>
