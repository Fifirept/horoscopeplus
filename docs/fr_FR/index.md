...
**Utilisation :**</p>
	Sur une commande de design :</p>
		1. Ajouter la commande `Logo` de l'équipement HoroscopePlus sur un design</p>
	...
	2. Dans la configuration de la commande > Affichage > Widget, sélectionner `Customtemp/HoroscopePlus_logo`</p>
	...
	3. Le logo s'affiche et ouvre automatiquement le bon horoscope au clic</p>
...
Dans un virtuel :</p>
	1. Créer un nouveau virtuel</p>
	2. Importer les commandes `Logo` + `date` (optionnel) de chaque signe à visualiser</p>
	...
	3. Dans la configuration de la commande `Logo`> Affichage > Widget, sélectionner `Customtemp/HoroscopePlus_logo`</p>
	...
	4. Optionnel : Afficher le virtuel en mode "tableau </p>
